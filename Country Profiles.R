...
Austria<-c("Austria","AT","AUT",
           ...
           "Austria's international tax system is very good with a broad tax treaty network of 89 countries, Controlled Foreign Corporation rules that only apply to subsidiaries that do not have substantial economic activity, and thin capitalization rules that are less complex than in most countries.",
