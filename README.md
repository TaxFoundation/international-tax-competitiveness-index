...
| `corporate_other_rev` | Complexity of tax system measured by the share of corporate tax revenue that a country does not attribute to the ordinary income taxes, calculated as `(1300 + 6100) / (1300 + 6100 + 1200)`. Code 1300 is income tax revenue the reporting country cannot allocate between individuals (1100) and corporations (1200); code 6100 is other taxes paid solely by business. A high share therefore indicates that a large part of business-borne revenue is raised outside the ordinary corporate income tax or cannot be assigned to it, rather than the existence of unusual taxes as such. Codes 1300 and 6100 are siblings of 1200 in the OECD classification rather than subsets of it, so the numerator is added into the denominator. 2-year time lag.|
...
| `personal_other_rev` |Complexity of tax system measured by the share of social security contributions that a country does not attribute to a payer group, calculated as `2400 / 2000`. Code 2400 is contributions the reporting country cannot allocate between employees (2100), employers (2200) and the self-employed or non-employed (2300). It is a subset of 2000 (total social security contributions), so the denominator is 2000 alone. The inability to allocate is itself treated as an indicator of complexity: the OECD requests the same breakdown from every member, and a country that cannot supply it is scored accordingly. Colombia, Iceland and Mexico report no breakdown at all and therefore score 1. 2-year time lag.|
