...
#2019
raw_data_2019 <- read_csv(paste(final_data,"final_index_data_2019_Option_A.csv",sep=""))
...
write.csv(United_Kingdom,paste(final_outputs,"United_Kingdom_Option_A.csv",sep=""),row.names=F)
