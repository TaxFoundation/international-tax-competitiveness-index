...
pwc_paying_taxes<-
  ...
  rename(
     ...
     consumption_payments_2018 = `2018__6`,
     ...
     consumption_payments_2017 = `2017__6`,
     ...
     consumption_payments_2016 = `2016__6`,
     ...
     consumption_payments_2015 = `2015__6`,
     ...
     consumption_payments_2014 = `2014__6`,
...
pwc_paying_taxes_2018<-  pwc_paying_taxes_2018 %>%
  rename(corporate_time = corporate_time_2018,
    ...
    consumption_payments = consumption_payments_2018,
...
pwc_paying_taxes_2017<-  pwc_paying_taxes_2017 %>%
  rename(corporate_time = corporate_time_2017,
         ...
         consumption_payments = consumption_payments_2017,
...
pwc_paying_taxes_2016<-  pwc_paying_taxes_2016 %>%
  rename(corporate_time = corporate_time_2016,
         ...
         consumption_payments = consumption_payments_2016,
...
pwc_paying_taxes_2015<-  pwc_paying_taxes_2015 %>%
  rename(corporate_time = corporate_time_2015,
         ...
         consumption_payments = consumption_payments_2015,
...
pwc_paying_taxes_2014<-  pwc_paying_taxes_2014 %>%
  rename(corporate_time = corporate_time_2014,
         ...
         consumption_payments = consumption_payments_2014,
...
pwc_paying_taxes<-pwc_paying_taxes[,-c(2:3,11:12)]
