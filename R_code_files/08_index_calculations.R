...
#Combined Data####
raw_data<-rbind(raw_data_2014,raw_data_2015,raw_data_2016,raw_data_2017,raw_data_2018,raw_data_2019,raw_data_2020,raw_data_2021)
...
incentives_index<-c("patent_box","r_and_d_credit","digital_services_tax")
...
income_index<-c("capital_gains_and_dividends","income_tax")
